...
const ElectronicsSection = () => {
  ...
  const electronicsData = [
    { id: 1,  imgSrc: 'images/macbook.png', text: 'Laptop Support',link: '/ACRepairPage' } ,
    { imgSrc: 'images/macbook.png', text: 'Desktop Support' },
    { imgSrc: 'images/macbook.png', text: 'Macbook support' },
    { imgSrc: 'images/macbook.png', text: 'Printer Support' },
    { imgSrc: 'images/macbook.png', text: 'Coding issue' },
    { imgSrc: 'images/macbook.png', text: 'Component Replacement' },
